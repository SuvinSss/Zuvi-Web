...
def _demo_otp_unavailable_response():
    """Retire demo authentication without consuming session or account data."""
    return HttpResponseGone(
        "Mobile sign-in is unavailable. Please use password sign-in.",
...
def customer_otp_start_view(request):
    return _demo_otp_unavailable_response()
